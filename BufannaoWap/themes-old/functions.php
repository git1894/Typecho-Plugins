...
function themeInit($archive) {
    // 判断是否是文章，如果是就插入广告
    $ad_code = '<div style="margin-bottom: 16px;">
...
<li id="li-<?php $comments->theId(); ?>" class="comment-body<?php 
	...
	echo $commentClass;
	?>">
    <div id="<?php $comments->theId(); ?>" class="comment-meta">
		<div class="comment-meta-avatar"><?php $comments->gravatar('40', ''); ?></div>
		<div class="comment-meta-author"><strong><a href="#" rel="external nofollow" target="_blank"><?php $comments->author(); ?></a></strong></div>
		<div class="comment-meta-time"><?php $comments->date('Y-m-d H:i'); ?></div>
		<div class="comment-meta-reply"><?php $comments->reply(); ?></div>
    </div>
